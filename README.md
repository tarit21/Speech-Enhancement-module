...
<img src="denoise_10classes.gif" alt="Spectrogram denoising" title="Speech enhancement"/>
...
<img src="sound_to_spectrogram.png" alt="sound representation" title="sound representation" />
...
<img src="structure_folder.png" alt="data folder structure" title="data folder structure" />
...
<img src="Unet_noisyvoice_to_noisemodel.png" alt="Unet training" title="Unet training" />
...
<img src="loss_training.png" alt="loss training" title="loss training" />
...
<img src="flow_prediction.png" alt="flow prediction part 1" title="flow prediction part 1" />
...
<img src="flow_prediction_part2.png" alt="flow prediction part 2" title="flow prediction part 2" />
...
<img src="validation_spec_examples.png" alt="validation examples" title="Spectrogram validation examples" />

Let's hear the results converted back to sounds:

> Audios for Alarm example:

[Input example alarm](noisy_voice_alarm39.wav)

[Predicted output example alarm](voice_pred_alarm39.wav)

[True output example alarm](voice_alarm39.wav)

> Audios for Insects example:

[Input example insects](noisy_voice_insect41.wav)

[Predicted output example insects](voice_pred_insect41.wav)

[True output example insects](voice_insect41.wav)

> Audios for Vaccum cleaner example:

[Input example vaccum cleaner](noisy_voice_vaccum35.wav)

[Predicted output example vaccum cleaner](voice_pred_vaccum35.wav)

[True output example vaccum cleaner](voice_vaccum35.wav)

> Audios for Bells example:

[Input example bells](noisy_voice_bells28.wav)

[Predicted output example bells](voice_pred_bells28.wav)

[True output example bells](voice_bells28.wav)

Below I show the corresponding displays converting back to time series:

<img src="validation_timeserie_examples.png" alt="validation examples timeserie" title="Time serie validation examples" />
...
<img src="denoise_ts_10classes.gif" alt="Timeserie denoising" title="Speech enhancement"/>
...
[Input example test 1](noisy_voice_long_t2.wav)

[Predicted output example test 1](denoise_t2.wav)

> Example 2:

[Input example test 2](noisy_voice_long_t1.wav)
...
This repository is developed by [Tarit Sengupta](https://github.com/tarit21).  It is distributed under Apache License 2.0.
